...
sam_args = {
    'sam_checkpoint': 'Segment-and-Track-Anything/ckpt/sam_vit_b_01ec64.pth',#"ckpt/sam_vit_b_01ec64.pth", 
    'model_type': "vit_b",
    'generator_args':{
        'points_per_side': 16,
        'pred_iou_thresh': 0.8,
...
aot_args = {
    'phase': 'PRE_YTB_DAV',
    'model': 'r50_deaotl',
    'model_path': 'Segment-and-Track-Anything/ckpt/R50_DeAOTL_PRE_YTB_DAV.pth', #'ckpt/R50_DeAOTL_PRE_YTB_DAV.pth',#
